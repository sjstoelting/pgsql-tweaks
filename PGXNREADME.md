...
[![version](https://img.shields.io/badge/PostgreSQL-16-beta-1-blue.svg)]()
...
1.4.4.2 [replace_latin1\(s text, replacement text\)](#replace_latin1\(s.text, replacement text\)r />
...
1.4.6.1 [replace_encoding\(s text, e text\)](#replace_encoding\(s.text, e text\)r />
1.4.6.2 [replace_encoding\(s text, e text, replacement text\)](#replace_encoding\(s.text, e text, replacement text\) />
